...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wajeeh-hassan/UIView-TapListnerCallback'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wajeehulhassan' => 'wajeeh661@gmail.com' }
  s.source           = { :git => 'https://github.com/wajeeh-hassan/UIView-TapListnerCallback.git', :tag => s.version.to_s }
